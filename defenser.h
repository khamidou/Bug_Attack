/**
* @file defenser.h
* @brief Ce fichier contient toutes les classes de défenseurs (tourelles) du jeu.
* Il est également possible de réaliser ses propres défenseurs en dérivant de la classe
* patron "Defenser"
*/
...
public:
    Defenser(int posx,int posy,unsigned int level,Map* map);
    unsigned int getLevel(void) const;
    virtual int getCost(unsigned int level = 0) const = 0;
...
public:
    ...
    WaterGun(int posx,int posy,unsigned int level,Map* map);
    int getCost(unsigned int level = 0) const;
...
public:
    ...
    Slingshot(int posx,int posy,unsigned int level,Map* map);
    int getCost(unsigned int level = 0) const;
    QString getInfos(void) const;
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *so, QWidget *w);
    static int getBasicCost(void) { return BASIC_COST; }
...
public:
    ...
    Paintball(int posx,int posy,unsigned int level,Map* map);
    int getCost(unsigned int level = 0) const;
    QString getInfos(void) const;
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *so, QWidget *w);
    static int getBasicCost(void) { return BASIC_COST; }
...
public:
    ...
    Bowling(int posx,int posy,unsigned int level,Map* map);
    int getCost(unsigned int level = 0) const;
    QString getInfos(void) const;
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *so, QWidget *w);
    static int getBasicCost(void) { return BASIC_COST; }
...
public:
    ...
    Musician(int posx,int posy,unsigned int level,Map* map);
    int getCost(unsigned int level = 0) const;
    QString getInfos(void) const;
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *so, QWidget *w);
    static int getBasicCost(void) { return BASIC_COST; }
